                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="-m-2">
                        ...
                        <form method="POST" action="{{ route('admin.data.sales_destroy') }}" class=" p-1" >
                            ...
                            <span class="items-center text-sm mt-2" >　週　　　</span>
                            <button type="submit" class="text-white bg-indigo-500 border-0 py-1 px-4 focus:outline-none hover:bg-indigo-600 rounded">売上データ削除</button>
                        </form>
                        ...
                        <form method="POST" action="{{ route('admin.data.deliv_destroy') }}" class=" p-1" >
                            ...
                            <span class="items-center text-sm mt-2" >　週　　　</span>
                            <button type="submit" class="text-white bg-indigo-500 border-0 py-1 px-4 focus:outline-none hover:bg-indigo-600 rounded">納品データ削除</button>
                        </form>
