                          ...
                          <div class="lg:w-1/2 md:w-2/3 mx-auto">
                            ...
                            <div class="-m-2">
                              ...
                              <div class="p-2 w-full mt-4 flex justify-around">
                                <button type="button" onclick="location.href='{{ route('admin.users.index') }}'" class="h-10 text-black bg-gray-300 border-0 py-2 px-8 focus:outline-none hover:bg-gray-300 rounded ">戻る</button>
