               ...
               <thead>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="w-4/15 md:px-4 py-1 text-left">{{ Str::limit($product->hinmei,20) }}</td>
            ...
            <table class="md: bg-white table-auto w-full text-center whitespace-no-wrap">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="w-4/15 h-2 pl-2 text-sm md:px-2 py-0 text-left ">{{ Str::limit($product->hinmei,20) }}</td>
