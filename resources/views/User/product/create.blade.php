                    ...
                    <div class="-m-2">
                        ...
                        <div class="p-2 w-1/2 mx-auto">
                            <div class="relative flex justify-around">
                              <div><input type="radio" name="is_selling" class="mr-4" value="1"  checked >販売中</div>
                              <div><input type="radio" name="is_selling" class="mr-4" value="0" >停止中</div>
                            </div>
                          </div>
                        ...
                        <div class="p-2 w-1/2 mx-auto">
                          ...
                          <div class="p-2 w-full mt-4 flex justify-around">
                            <button type="button" onclick="location.href='{{ route('owner.products.index') }}'" class="text-black bg-gray-300 border-0 py-2 px-8 focus:outline-none hover:bg-gray-300 rounded text-lg">戻る</button>
