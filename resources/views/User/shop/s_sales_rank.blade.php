    ...
    <div class="py-6 border">
        <div class=" mx-auto px-4 sm:px-4 lg:px-4 border ">
            <table class="w-full bg-white table-auto md:w-1/2 text-center whitespace-no-wrap">
                ...
                <tr>
                    <td class="w-2/8 md:px-4 py-1">{{ $s_rank->co_name }}</td>
                    <td class="w-2/8 md:px-4 py-1">{{ $s_rank->shop_name }}</td>
                    <td class="w-2/8 pr-6 md:px-4 py-1 text-right">{{ number_format($s_rank->pcs)}}</td>
                    <td class="w-2/8 pr-10 md:px-4 py-1 text-right">{{ number_format(round($s_rank->kingaku)/1000)}}</td>
                </tr>
                @endforeach
