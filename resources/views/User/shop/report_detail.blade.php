                                ...
                                <div class="p-2 w-full mx-auto">
                                    ...
                                    <div class="mx-auto mb-1">
                                        <div class="relative">
                                            ...
                                            <div id="information" name="information" rows="10" class="w-full bg-gray-100 bg-opacity-50 border rounded focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">{!! nl2br(e($report->comment)) !!}</div>
                                        </div>
                                    </div>
