            ...
            <div class="md:flex">
                ...
                <div class="flex mb-2">
                    <span class="items-center text-sm mt-2 text-gray-800 dark:text-gray-200 leading-tight" >エリア　: </span>
                        <select class="w-32 h-8 rounded text-sm ml-1 md:ml-4" id="ar_id" name="ar_id"  class="border">
                ...
                <div class="mb-2 md:flex md:ml-4">
                    ...
                    <select class="w-32 h-8 mb-2 rounded text-sm border mr-4 md:ml-4" id="co_id" name="co_id" >
                    ...
                    <span class="items-center text-sm mt-2  text-gray-800 dark:text-gray-200 leading-tight" >店名　:</span>
                     <input class="w-44 h-8 rounded text-sm ml-0 md:ml-4" id="sh_name" placeholder="店名入力（一部でも可）" name="sh_name" >
                    </div>
                </div>
                <div class="flex ml-10 md:ml-2">
                <div class="ml-0 md:ml-2">
                    <button type="button" class="w-20 h-8 bg-indigo-400 text-white ml-2 hover:bg-indigo-600 rounded" onclick="location.href='{{ route('user.shop.report_list') }}'" class="mb-2 ml-2 text-right text-black bg-glay-300 border-0 py-0 px-2 focus:outline-none hover:bg-glay-00 rounded ">全表示</button>
                </div>
