    ...
    <x-slot name="header">
        ...
        <form method="get" action="{{ route('user.shop.report_list')}}" class="mt-4">
            ...
            <div class="md:flex">
                ...
                <div class="flex mb-4">
                    <span class="items-center text-sm mt-2" >エリア： 　</span>
                        <select class="w-32 h-8 text-sm" id="ar_id" name="ar_id"  class="border">
                ...
                <div class="flex mb-4">
                    <span class="items-center text-sm mt-2" >会社： 　</span>
                        <select class="w-32 h-8 text-sm border mr-4" id="co_id" name="co_id" >
                        ...
                        @endforeach
                         ...
                         <span class="items-center text-sm mt-2 " >店名:　</span>
                     <input class="w-44 h-8 text-sm" id="sh_name" placeholder="店名入力（一部でも可）" name="sh_name" >
                </div>
                <div class="flex ml-60 md:ml-2">
