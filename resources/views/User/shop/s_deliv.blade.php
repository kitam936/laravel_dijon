...
<x-app-layout>
    <x-slot name="header">
        ...
        <form method="get" action="{{ route('user.shop.s_sd_form',['shop'=>$shop->id])}}" class="mt-4">
            ...
            <div class="flex ml-0">
                    ...
                    <span class="items-center rounded text-sm mt-2 text-gray-800 dark:text-gray-200 leading-tight" >　～　</span>
