...
<x-app-layout>
    <x-slot name="header">
        ...
        <span class="items-center text-sm mt-2 text-gray-800 dark:text-gray-200 leading-tight" >　※エリア・会社・期間を選択してください</span>
          ...
          <form method="get" action="{{ route('user.shop.s_delivs_rank')}}" class="mt-4">
            <div class="md:flex">
                ...
                <div class="mb-2 ml-2 md:flex mb-4">
                    ...
                    <select class="w-28 md:w-32 h-8 rounded text-sm pt-1" id="ar_id" name="ar_id"  class="border">
                ...
                <div class="flex ml-4 mb-2 md:flex md:ml-2 mb-4">
                    <label class="pr-1 items-center text-sm mt-2 md:ml-0 text-gray-800 dark:text-gray-200 leading-tight" ></label>
                        <select class="w-28 md:w-32 h-8 ml-2 rounded text-sm pt-1 " id="co_id" name="co_id"  class="border">
                        <option value="" @if(\Request::get('co_id') == '0') selected @endif >全店</option>
