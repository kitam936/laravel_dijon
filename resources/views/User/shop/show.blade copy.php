        ...
        <form method="get" action="" class="mt-4">
            ...
            <div class="md:flex">
                ...
                <div class="flex pl-0 mt-0">
                    ...
                    <div class="pl-2  ml-0 md:ml-2 w-32 h-8 items-center bg-gray-100 border" name="co_id"  value="">{{ $shop->co_name }}</div>
                </div>
                ...
                <div class="flex pl- mt-1 md:mt-0">
                    ...
                    <div class="pl-2 w-32 h-8 items-center bg-gray-100 border md:ml-2" name="sh_id" value="">{{ $shop->id }}</div>
                </div>
                ...
                <div class="flex pl-0 mt-1 md:mt-0">
                    ...
                    <div class="pl-2 ml-0 md:ml-2 w-80 h-8 items-center bg-gray-100 border" name="sh_info" value="">{{ $shop->shop_info }}</div>
                </div>
