...
<x-app-layout>
    <x-slot name="header">
        ...
        <form method="get" action="{{ route('user.company.search_uz_form')}}" class="mt-2">
            <div class="flex">
            <div class="flex mb-2">
            ...
            {{-- <div class="ml-16 py-2 border mt-2"> --}}
            ...
            <table class="w-full md:w-1/2 bg-white table-auto w-full text-center whitespace-no-wrap">
                <thead>
                    ...
                    <tr>
                        ...
                        <td class="w-1/12 pr-4 md:px-4 py-1 text-right"><span style="font-variant-numeric:tabular-nums"> {{ number_format($u_stock->pcs)}}</span></td>
                        <td class="w-3/12 pr-12 md:px-4 py-1 text-right"><span style="font-variant-numeric:tabular-nums"> {{ number_format(round($u_stock->zaikogaku)/1000)}}</span></td>
                    </tr>
                @endforeach
