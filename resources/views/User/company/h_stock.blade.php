        ...
        <div class=" mx-auto sm:px-4 lg:px-4 border">
            ...
            <table class="w-2 bg-white table-auto md:w-3/4 text-center whitespace-no-wrap">
                ...
                <tr>
                    ...
                    <th class="w-3/12 md:px-4 py-1 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">在庫額</th>
                </tr>
                </thead>
                ...
                <tr>
                    <td class="w-1/12 md:px-4 py-1">{{ $h_stock->hinban->unit_id }}</td>
                    <td class="w-1/12 md:px-4 py-1">{{ $h_stock->hinban_id }}</td>
                    <td class="w-6/12 md:px-4 py-1 text-left">{{ $h_stock->hinban->hinmei }}</td>
                    <td class="w-1/12 md:px-4 py-1 text-right">{{ number_format($h_stock->pcs)}}</td>
                    <td class="w-3/12 md:px-4 py-1 text-right">{{ number_format($h_stock->zaikogaku)}}</td>
                </tr>
                @endforeach
                {{-- @endforeach --}}
                </tbody>
